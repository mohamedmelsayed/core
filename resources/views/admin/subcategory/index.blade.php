                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--primary editBtn" data-name_en="{{ $subcategory->name_en }}" data-name="{{ $subcategory->name }}" data-id="{{ $subcategory->id }}" data-type="{{ $subcategory->type }}" data-category_id="{{ $subcategory->category_id }}" data-status="{{ $subcategory->status }}"><i
