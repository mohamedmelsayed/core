    ...
    <li class="wishlist-card-list__item">
        <div class="wishlist-card-wrapper">
            ...
            <div class="wishlist-card-wrapper__icon">
                <button class="base--color basicConfirmationBtn" data-action="{{ route('user.remove.history', $history->id) }}" data-question="@lang('Are you sure to remove this item?')" type="button"><i class="las la-times"></i></button>
            </div>
        </div>
    </li>
@empty
