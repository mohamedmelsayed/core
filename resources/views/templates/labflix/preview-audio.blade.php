        ...
        <div class="container">
            <div class="row @if (blank($episodes)) justify-content-center @endif mb-30-none">
                <div class="col-xl-8 col-lg-8 mb-30">
                    <div class="audio-item" style="position: relative; overflow: hidden;">
                        <!-- Background Image and Mask -->
                        <div class="audio-background" style="background-image: url('{{ getImage(getFilePath('item_landscape') . '/' . $item->image->landscape) }}');"></div>
...
.plyr__progress input[type="range"] {
    background: url('/path-to-your-equalizer-image/equalizer-waves.png') no-repeat center;
    background-size: cover;
    border: none;
    height: 10px;
    outline: none;
