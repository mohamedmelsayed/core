...
<script src="https://cdn.jsdelivr.net/npm/plyr-youtube/dist/plyr-youtube.min.js"></script>
...
<script>
    ...
    (function($) {
        ...
        let player = new Plyr('.video-player', {
            controls,
            ratio: '16:9',
            youtube: { // Plyr YouTube plugin settings
                noCookie: true, // Enable YouTube no-cookie mode
