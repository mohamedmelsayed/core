    ...
    <li class="wishlist-card-list__item">
        <div class="wishlist-card-wrapper">
            ...
            <div class="wishlist-card-wrapper__icon">
                <button class="text--base basicConfirmationBtn" data-action="{{ route('user.wishlist.remove', $wishlist->id) }}" data-question="@lang('Are you sure to remove this item?')" type="button"><i class="las la-times"></i></button>
            </div>
        </div>
    </li>
@empty
