                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-none" id="rentalArea">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="exclude_plan">
                                        <option value="">@lang('Select One')</option>
                                ...
                                <select class="form-control" name="category" required>
                                    ...
                                    @foreach ($categories as $category)
                                        <option data-subcategories="{{ $category->subcategories }}"
                                            ...
                                            {{ $category->type == 'vid' ? __('video') : __('audio') }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-4 position-relative">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="ratings" type="number"
                                        value="{{ old('ratings') }}" step="any" placeholder="Ratings">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 position-relative">
                                ...
                                <small class="text-facebook ml-2 mt-2">@lang('Separate multiple by')
...
@push('script')
    <script>
        ...
        (function($) {
            ...
            $('select[name=version]').val('{{ old('
                        version ') }}');
            $('select[name=category]').val('{{ old('
                        category ') }}');
            $('select[name=sub_category_id]').val('{{ old('
                        sub_category_id ') }}');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            var directorOption = '';
                            $.each(casts.crew, function(index, value) {
                                if (value.known_for_department == "Directing" && (value
                                        .job == "Screenplay" || value.job == "Director")) {
                                    directorOption +=
                                        `<option value="${value.name}" selected>${value.name}</option>`
                                }
                            });
