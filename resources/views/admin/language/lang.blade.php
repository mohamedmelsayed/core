...
@section('panel')
    ...
    <div class="modal fade" id="getLangModal" role="dialog" aria-labelledby="getLangModalLabel" aria-hidden="true" tabindex="-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group copy-texts-wrapper position-relative">
                        ...
                        <textarea class="form-control langKeys key-added" id="langKeys" name="" rows="25" readonly></textarea>
                    </div>
                </div>
            </div>
        </div>
